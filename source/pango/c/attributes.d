...
pure GType       pango_color_get_type ();
 ...
 * Since: 1.24
 */
enum PANGO_ATTR_INDEX_FROM_TEXT_BEGINNING = 0;
enum PANGO_ATTR_INDEX_TO_TEXT_END = G_MAXUINT;
 ...
 **/
alias PangoAttrFilterFunc = gboolean function (PangoAttribute *attribute,
					 gpointer        user_data);
 ...
 **/
alias PangoAttrDataCopyFunc = gpointer function (gconstpointer user_data);
...
pure const(char) *          pango_attr_type_get_name (PangoAttrType       type);

void             pango_attribute_init        (PangoAttribute       *attr,
					      const(PangoAttrClass) *klass);
PangoAttribute * pango_attribute_copy        (const(PangoAttribute) *attr);
void             pango_attribute_destroy     (PangoAttribute       *attr);
pure gboolean         pango_attribute_equal       (const(PangoAttribute) *attr1,
...
pure GType              pango_attr_list_get_type      ();
