...
version (Backend) {
    ...
    pure GType pango_engine_get_type ();
    ...
    struct PangoEngineLangClass
    {
      ...
      /*< public >*/
      void function (PangoEngineLang *engine,
			    const(char)    *text,
			    int            len,
			    PangoAnalysis *analysis,
			    PangoLogAttr  *attrs,
			    int            attrs_len) script_break;
    };

    pure GType pango_engine_lang_get_type ();
    ...
    struct PangoEngineShapeClass
    {
      ...
      /*< public >*/
      void function (PangoEngineShape    *engine,
			    PangoFont           *font,
			    ...
			    uint         paragraph_length) script_shape;
      PangoCoverageLevel function   (PangoEngineShape *engine,
				      PangoFont        *font,
